...
type DFGet interface {
	GetFile(ctx context.Context, cfg *config.Config) *errortypes.DfError
	GetReader(ctx context.Context, cfg *config.Config) (io.Reader, *errortypes.DfError)
}
...
func (df *dfGet) GetFile(ctx context.Context, cfg *config.Config) *errortypes.DfError {
	return Start(cfg)
}

func (df *dfGet) GetReader(ctx context.Context, cfg *config.Config) (io.Reader, *errortypes.DfError) {
